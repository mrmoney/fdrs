<?php
define('WXPAY_LIB_DIR',dirname(__FILE__));
require_once WXPAY_LIB_DIR . "/WxPay.Exception.php";
require_once WXPAY_LIB_DIR . "/WxPay.Config.php";
require_once WXPAY_LIB_DIR . "/WxPay.Data.php";
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		if(!$inputObj->IsNotify_urlSet()){
			$inputObj->SetNotify_url(WxPayConfig::NOTIFY_PAY_URL);//异步通知url
		}
