<?php
class Default_Controller_Default extends Base_Controller_Default
{
	//验证码
	public function authcode()
	{
		...
		//生产验证码字符
		$ychar = '1,2,3,4,5,6,7,8,9,A,B,C,D,E,F,G,H,I,J,K,L,M,N,P,P,Q,R,S,T,U,V,W,X,Y,Z'; 
		$list=explode(',',$ychar); 
		for($i = 0; $i < 4; $i++)
		{ 
			$randnum = rand(0,35); 
		...
		{ 
			imagestring($aimg, mt_rand(3,5),$i*$img_height/4+mt_rand(2,7),mt_rand(1,$img_width/2-2), $authnum[$i],
