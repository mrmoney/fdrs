...
function highlight(data){
	...
	var UGHtml="<div class='UGCode' style='border:1px dashed #ccc;font:12px/18px \'Courier New\',Courier,monospace;'>\n";
	UGHtml+="<div class='UGTitle' style='padding:5px 10px;height:20px;line-height:20px;font-weight:bold;border-bottom:1px dashed #ccc;'>"+UGT+"</div>\n";
	UGHtml+=data;
	UGHtml+="</div>\n";
