<?php /* Smarty version Smarty-3.0.8, created on 2018-06-22 10:18:38
         compiled from "E:\mrmoney\baoxiang\fdrs\/templates/ussv\product/index.html" */ ?>
<?php /*%%SmartyHeaderCode:302275b2c5c7e97c711-71180032%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae238e1f9630d2d2a8ffadb5d853774324185089' => 
    array (
      0 => 'E:\\mrmoney\\baoxiang\\fdrs\\/templates/ussv\\product/index.html',
      1 => 1528809621,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '302275b2c5c7e97c711-71180032',
  'function' => 
  array (
  ),
...
';
var leftTree = null;
var ary_types1 = <?php echo $_smarty_tpl->getVariable('product_types')->value;?>
;var grid = null;
...
{
    var batch_menus = [
                        {id: "delete_product", text: "删除", iconCls:"icon-remove"},
                        {id: "enable_product", text: "发布", status:1,act:'update_status', iconCls:"icon-upload"},
                        {id: "disable_product", text: "临时下线", status:0,act:'update_status', iconCls:"icon-download"},
                        {id: "reset_type", text: "转移分类", iconCls:"icon-reload"},
                        {id: "add_to_cart", text: "加入购物车", iconCls:"icon-redo"}
                    ];
...
{
    if(title == undefined){ title = '录入新装备'; }
...
function onclick_batch_item(e)
{
    ...
    switch(node.id)
    {
        ...
        case 'add_to_cart':
            ...
            showloading('正在执行...');
            $.ajax({
                url: '/?app=cart_controller_ussv&act=push',
                data: data,type:'post',
        ...
        <div class="mini-toolbar top_bar">
            <table style="width:100%;">
                ...
                <td style="white-space:nowrap;">
                    ...
                    <ul id="batchMenu" class="mini-menu" textField="text" idField="id" parentField="pid" onitemclick="onclick_batch_item"></ul>
                </td>
                </tr>
            </table>
        </div>
...
&act=query_products">
                <div property="columns">
                    ...
                    <div field="price1" width="60" headerAlign="center" align="right"
                            dataType="currency" currencyUnit="￥">本站售价</div>                
                    <div field="price2" width="60" headerAlign="center" align="right"
                            dataType="currency" currencyUnit="￥">市场售价</div>                
                    <div field="typename" width="70" headerAlign="center" 
